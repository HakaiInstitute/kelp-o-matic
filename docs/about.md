...
=== "Test split"
    ...
    |:----------|-------:|----------:|-------:|---------:|
    | Kelp      | 0.6541 |    0.8296 | 0.7523 |          |
    | Not Kelp  | 0.9884 |    0.9937 | 0.9946 |          |
    | *Overall* | 0.8213 |    0.9117 | 0.8734 |   0.9890 |
...
=== "Validation split"
    ...
    | *Overall* | 0.8410 |    0.8777 | 0.9402 |   0.9865 |
...
=== "Train split"
    ...
    | *Overall* | 0.8751 |    0.9200 | 0.9401 |   0.9757 |
...
=== "Test split"
    ...
    | Nereo     | 0.5262 |    0.7452 | 0.6435 |          |
    | Not Kelp  | 0.9883 |    0.9937 | 0.9946 |          |
    | *Overall* | 0.7607 |    0.8742 | 0.8270 |   0.9880 |
...
=== "Validation split"
    ...
    | *Overall* | 0.7810 |    0.8367 | 0.9055 |   0.9522 |
...
=== "Train split"
    ...
    | *Overall* | 0.8118 |    0.8719 | 0.8855 |   0.9649 |
